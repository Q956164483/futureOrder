...
;(function(){
    ...
    var hasGetHeadImg = 0,
        headImg = 'dist/css/image/icon-head_default.png';
    function getUserInfo(){
        var access_token = encodeURIComponent(getQueryString('access_token'));
        var openid = encodeURIComponent(getQueryString('openid'));
        $.ajax({
            type: 'GET',
            url: '/geWinXinUserInfo?access_token='+access_token+'&openid='+openid+'&lang=zh_CN',
            dataType: 'json',
            timeout: 10000,
        ...
        function initdynamics(){
            var dynamics ={
                dynamics:[{
                    ...
                    type:'image',
                    images:['dist/css/image/dynamic2_1.jpg','dist/css/image/dynamic2_2.jpg','dist/css/image/dynamic2_3.jpg','dist/css/image/dynamic2_4.jpg','dist/css/image/dynamic2_5.jpg','dist/css/image/dynamic2_6.jpg','dist/css/image/dynamic2_7.jpg','dist/css/image/dynamic2_8.jpg','dist/css/image/dynamic2_9.jpg'],
                    time:'3分钟前',
                    video:'',
                    ...
                    type:'image',
                    images:['dist/css/image/dynamic3_1.jpg','dist/css/image/dynamic3_2.jpg','dist/css/image/dynamic3_3.jpg'],
                    time:'10分钟前',
                    video:'',
                    ...
                    type:'image',
                    images:['dist/css/image/dynamic4_1.jpg','dist/css/image/dynamic4_2.jpg','dist/css/image/dynamic4_3.jpg'],
                    time:'13分钟前',
                    video:'',
    ...
    function loadResource(callback){
        ...
        for(var i = 0; i < len; i++){
            ...
            if(type == 'mp3'||type == 'wav'){
                ...
                Aresource[i].src = 'dist/css/image/'+urlObj[i];
                saveResourse(i,'img');
            }
